...
class CampaignIndex extends Component {
  state = {
    ...
    contractAddress: "0xA0b069B167eCec84dEc20E124252C5c002e414fF",
    loading: false,
    isloading: false,
    burnloading: false,
    mintPrice: 0,
  ...
  async componentDidMount() {
    ...
    const one = Nft__factory.connect(
      "0xA0b069B167eCec84dEc20E124252C5c002e414fF",
      window.ethereum
    );
        ...
        <div className={styles.top}>
          <div className={styles.box}>
            ...
            <div className={styles.price}>
              <div
                className={styles.innerPrice}
                style={this.state.number == 0 ? { width: "400px" } : {}}
              >
                Mint Price: <br />
                {Number(this.state.mintPrice.toString()) /
                  1000000000000000000}{" "}
                Eth
              </div>
              {this.state.number > 0 ? (
                <div className={styles.innerPrice}>
                  Burn Price: <br />
                  {Number(this.state.burnPrice.toString()) /
                    1000000000000000000}{" "}
                  Eth
                </div>
              ) : (
